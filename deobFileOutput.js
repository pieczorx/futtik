...
(function (r8R, B8R) {
    ...
    r8R[X2LL.C4R] = function (Q8R, a8R, V8R, C8R, X8R) {
        ...
        for (V8R = Q8R[Z8P.z4R]; V8R--;) {
            B8R[u4R](Q8R[V8R], i4R);
            for (C8R = X8R[Z8P.z4R]; C8R--;)
                X8R[C8R][q4R][h4R] && a8R[Z8P.M4R](X8R[C8R]);
            B8R[J4R](Z8P.c8R);
        }
        return a8R;
    };
...
function FunCaptcha(w5R) {
    ...
    if (!w5R) {
        ...
        for (var f5R = G5R[L8P.z4R] - I8R; f5R >= L8P.c8R; f5R--)
            if (this[P4R](G5R[f5R])[t4R](this[H4R]) != -I8R) {
                ...
                if (this[z2P][F4R])
                    this[F4R] = this[z2P][F4R];
                if (this[z2P][u2P])
                    this[A4R] = this[z2P][u2P];
                if (this[z2P][l4R])
                    this[l4R] = this[z2P][l4R];
                if (this[z2P][i2P])
                    this[v4R] = this[z2P][i2P];
                if (this[z2P][L8P.q2P])
                    o5R = this[z2P][L8P.q2P];
                if (this[z2P][h2P])
                    U5R = this[z2P][h2P];
                if (this[z2P][M2P])
                    K5R = this[z2P][M2P];
                if (this[z2P][K4R])
                    this[K4R] = this[z2P][K4R];
                if (this[z2P][J2P])
                    this[Y4R] = b4R;
                if (this[z2P][o4R])
                    this[o4R] = b4R;
                if (this[z2P][g2P])
                    document[L8P.C4R](S2P)[L8P.c8R][k2P]();
            }
        if (o5R) {
            this[r2P]();
            return;
        ...
        if (!l5R && document[O2P]) {
            ...
            if (!l5R)
                l5R = document[O2P](E2P + this[A4R]);
        }
        if (!l5R)
            return;
        if (!this[F4R])
            this[F4R] = l5R[H2P](R2P);
    }
    if (!this[F4R])
        if (!w5R || !w5R[F4R]) {
            this[v2P](w2P);
    ...
    if (w5R && w5R[M2P])
        K5R = w5R[M2P];
    if (!window[l2P][K2P])
        window[l2P][K2P] = window[l2P][m2P] + U2P + window[l2P][Y2P] + (window[l2P][f2P] ? o2P + window[l2P][f2P] : G2P);
    ...
    this[L8P.Q4R] = function () {
        ...
        if (a9R[d2P])
            Object[y2P](a9R[d2P])[W2P](function (E9R) {
                I9R[L8P.M4R]({
                    key: E9R,
                    value: a9R[d2P][E9R]
                });
        ...
        if (typeof FunCaptchaBootstrap != b2P)
            for (var A9R in FunCaptchaBootstrap)
                I9R[L8P.M4R]({
                    key: A9R,
                    value: FunCaptchaBootstrap[A9R]
                });
        if (window[j2P]) {
            if (window[r1P] && B1P === typeof document[Q1P] && this[C1P]() && !(a9R[G4R] < J8R) && !(a9R[x4R] < z8R) && this[X1P]() && window[l2P][a1P][t4R](V1P) == -I8R)
                u9R[L8P.M4R]({
                    key: c1P,
                    value: I8R
                });
        ...
        var V9R;
        if (window[B0P])
            V9R = new XMLHttpRequest();
        V9R[L8P.Q0P] = function () {
            var X0P = 'status';
            if (this[L8P.C0P] == u8R && this[X0P] == d8R)
                a9R[N1P](V9R);
        };
        V9R[b1P](j1P, O9R, b4R);
        V9R[a0P](V0P, c0P);
    ...
    this[T2P] = function () {
        ...
        if (!this[U4R][I1P]) {
            ...
            this[U4R][A1P] = { f_true: n9R[v0P]() || n9R[w0P]() || n9R[l0P]() ? b4R : n9R[K0P]() ? f4R : b4R };
        }
        function t9R() {
            var d6P = 'x64Fmix';
            var D6P = 'x64Xor';
            ...
            this[H5P] = function () {
                var y9R = L8P.c8R, W9R, b9R;
                if (this[L8P.z4R] === L8P.c8R)
                    return y9R;
            ...
            this[U0P] = function () {
                ...
                var v5P = 'doNotTrack';
                if (navigator[v5P])
                    return navigator[v5P];
                else if (navigator[w5P])
                    return navigator[w5P];
                else if (window[v5P])
                    return window[v5P];
                else
                    return l5P;
            ...
            this[x0P] = function () {
                var r3R;
                if (screen[s5P] && screen[T5P])
                    r3R = screen[T5P] > screen[s5P] ? [
                        screen[T5P],
                        screen[s5P]
                    ] : [
                        screen[s5P],
            ...
            this[b0P] = function () {
                var t5P = 'addBehavior';
                if (document[p1P] && document[p1P][t5P])
                    return b4R;
                else
                    return f4R;
            };
            ...
            this[Q5P] = function () {
                var P5P = 'cpuClass';
                if (navigator[P5P])
                    return navigator[P5P];
                else
                    return l5P;
            };
            this[X5P] = function () {
                if (navigator[N5P])
                    return navigator[N5P];
                else
                    return l5P;
            };
            this[C1P] = function () {
            ...
            this[l0P] = function () {
                if (screen[G5P] < screen[s5P])
                    return b4R;
                if (screen[o5P] < screen[T5P])
                    return b4R;
                return f4R;
            };
            this[w0P] = function () {
                ...
                var I3R;
                if (u3R[t4R](Y9P) >= L8P.c8R)
                    I3R = f9P;
                else if (u3R[t4R](o9P) >= L8P.c8R)
                    I3R = G9P;
                else if (u3R[t4R](s9P) >= L8P.c8R)
                    I3R = p4R;
                else if (u3R[t4R](T9P) >= L8P.c8R)
                    I3R = L9P;
                else if (u3R[t4R](Z9P) >= L8P.c8R || u3R[t4R](x9P) >= L8P.c8R)
                    I3R = n9P;
                else if (u3R[t4R](t9P) >= L8P.c8R)
                    I3R = p9P;
                else
                    I3R = P9P;
                var i3R;
                if (N9P in window || navigator[D9P] > L8P.c8R || navigator[d9P] > L8P.c8R)
                    i3R = b4R;
                else
                    i3R = f4R;
                if (i3R && I3R !== f9P && I3R !== p4R && I3R !== n9P && I3R !== P9P && I3R !== G9P)
                    return b4R;
                if (typeof z3R !== b2P) {
                    z3R = z3R[m9P]();
                    if (z3R[t4R](o9P) >= L8P.c8R && I3R !== G9P && I3R !== f9P)
                        return b4R;
                    if (z3R[t4R](T9P) >= L8P.c8R && I3R !== L9P && I3R !== p4R)
                        return b4R;
                    if (z3R[t4R](t9P) >= L8P.c8R && I3R !== p9P && I3R !== n9P)
                        return b4R;
                    if (z3R[t4R](o9P) === L8P.c8R && z3R[t4R](T9P) === L8P.c8R && z3R[t4R](t9P) >= L8P.c8R && I3R !== y9P)
                        return b4R;
                }
                if (e3R[t4R](o9P) >= L8P.c8R && I3R !== G9P && I3R !== f9P)
                    return b4R;
                if ((e3R[t4R](T9P) >= L8P.c8R || e3R[t4R](s9P) >= L8P.c8R || e3R[t4R](W9P) >= L8P.c8R) && I3R !== L9P && I3R !== p4R)
                    return b4R;
                if ((e3R[t4R](t9P) >= L8P.c8R || e3R[t4R](x9P) >= L8P.c8R || e3R[t4R](b9P) >= L8P.c8R || e3R[t4R](Z9P) >= L8P.c8R) && I3R !== p9P && I3R !== n9P)
                    return b4R;
                if (e3R[t4R](o9P) === L8P.c8R && e3R[t4R](T9P) === L8P.c8R && e3R[t4R](t9P) >= L8P.c8R && I3R !== y9P)
                    return b4R;
                if (typeof navigator[j9P] === b2P && I3R !== G9P && I3R !== f9P)
                    return b4R;
                return f4R;
            };
            this[v0P] = function () {
                ...
                var q3R;
                if (h3R[t4R](B3P) >= L8P.c8R)
                    q3R = Q3P;
                else if (h3R[t4R](C3P) >= L8P.c8R || h3R[t4R](X3P) >= L8P.c8R)
                    q3R = a3P;
                else if (h3R[t4R](V3P) >= L8P.c8R)
                    q3R = c3P;
                else if (h3R[t4R](I3P) >= L8P.c8R)
                    q3R = e3P;
                else if (h3R[t4R](z3P) >= L8P.c8R)
                    q3R = u3P;
                else
                    q3R = P9P;
                if ((q3R === c3P || q3R === e3P || q3R === a3P) && g3R !== i3P)
                    return b4R;
                var M3R = eval[q3P]()[L8P.z4R];
                if (M3R === Y8R && q3R !== e3P && q3R !== Q3P && q3R !== P9P)
                    return b4R;
                if (M3R === f8R && q3R !== u3P && q3R !== P9P)
                    return b4R;
                if (M3R === U8R && q3R !== c3P && q3R !== a3P && q3R !== P9P)
                    return b4R;
                var J3R;
                try {
                    throw h3P;
            ...
            this[W7P] = function () {
                ...
                var b7P = 'appName';
                if (navigator[b7P] === j7P)
                    return b4R;
                if (navigator[b7P] === r6P && B6P[Q6P](navigator[T4R]))
                    return b4R;
                return f4R;
            };
            this[C6P] = function () {
            ...
            this[A5P] = function (I7R, u7R, i7R) {
                ...
                if (I7R === E4R)
                    return;
                if (this[X6P] && I7R[W2P] === this[X6P])
                    I7R[W2P](u7R, i7R);
                else if (I7R[L8P.z4R] === +I7R[L8P.z4R]) {
                    for (var e7R = L8P.c8R, q7R = I7R[L8P.z4R]; e7R < q7R; e7R++)
                        if (u7R[a6P](i7R, I7R[e7R], e7R, I7R) === {})
                            return;
                } else
                    for (var z7R in I7R)
                        if (I7R[u1P](z7R))
                            if (u7R[a6P](i7R, I7R[z7R], z7R, I7R) === {})
                                return;
            };
            this[V6P] = function (M7R, J7R, g7R) {
                ...
                if (M7R == E4R)
                    return h7R;
                if (this[c6P] && M7R[V6P] === this[c6P])
                    return M7R[V6P](J7R, g7R);
            ...
            this[q5P] = function () {
                ...
                if (this[W7P]()) {
                    ...
                    var O7R = [];
                    for (var F7R = L8P.c8R, R7R = navigator[j9P][L8P.z4R]; F7R < R7R; F7R++)
                        O7R[L8P.M4R](navigator[j9P][F7R]);
                    if (this[C6P]())
                        O7R = O7R[Y6P](function (l7R, K7R) {
                            if (l7R[f6P] > K7R[f6P])
                                return I8R;
                            if (l7R[f6P] < K7R[f6P])
                                return -I8R;
            ...
            this[M5P] = function () {
                ...
                var f7R = L8P.c8R;
                var o7R = f4R;
                if (typeof navigator[D9P] !== b2P)
                    f7R = navigator[D9P];
                else if (typeof navigator[d9P] !== b2P)
                    f7R = navigator[d9P];
                try {
                    document[Q1P](L6P);
                    o7R = b4R;
            ...
            this[n6P] = function (L7R, Z7R) {
                ...
                if (p7R === m8R)
                    ...
                    return [
                        P7R[L8P.c8R] << p7R | P7R[I8R] >>> m8R - p7R,
                        P7R[I8R] << p7R | P7R[L8P.c8R] >>> m8R - p7R
                    ];
                else {
                    p7R -= m8R;
                    return [
                ...
                if (N7R === L8P.c8R)
                    ...
                    return [
                        D7R[L8P.c8R] << N7R | D7R[I8R] >>> m8R - N7R,
                        D7R[I8R] << N7R
                    ];
                else
                    return [
                ...
                for (var j7R = L8P.c8R; j7R < I6R; j7R = j7R + E8R) {
                    r6R = [
                        b7R[R5P](j7R + u8R) & X8P | (b7R[R5P](j7R + i8R) & X8P) << M8R | (b7R[R5P](j7R + q8R) & X8P) << E8R | (b7R[R5P](j7R + h8R) & X8P) << v8R,
                        b7R[R5P](j7R) & X8P | (b7R[R5P](j7R + I8R) & X8P) << M8R | (b7R[R5P](j7R + e8R) & X8P) << E8R | (b7R[R5P](j7R + z8R) & X8P) << v8R
                    ];
                    B6R = [
                        b7R[R5P](j7R + k8R) & X8P | (b7R[R5P](j7R + A8R) & X8P) << M8R | (b7R[R5P](j7R + O8R) & X8P) << E8R | (b7R[R5P](j7R + F8R) & X8P) << v8R,
                        b7R[R5P](j7R + M8R) & X8P | (b7R[R5P](j7R + J8R) & X8P) << M8R | (b7R[R5P](j7R + g8R) & X8P) << E8R | (b7R[R5P](j7R + S8R) & X8P) << v8R
                    ];
    ...
    var p5R = function (R6R) {
        ...
        if (!R6R)
            return G2P;
        if (Array[L8P.r4R][K8P])
            return R6R[L8P.I4R](g4R)[K8P](function (l6R, K6R) {
                l6R = (l6R << i8R) - l6R + K6R[R5P](L8P.c8R);
                return l6R & l6R;
            }, L8P.c8R);
        var H6R = L8P.c8R;
        if (R6R[L8P.z4R] === L8P.c8R)
            return H6R;
    ...
    var m5R = {};
    m5R[U8P] = Y8P;
    m5R[R1P] = function (P6R, n6R) {
        var o8P = '\0';
        var f8P = '=';
        var H8R = 18;
        n6R = typeof n6R == b2P ? f4R : n6R;
        var d6R, y6R, W6R, Z6R, j6R, b6R, N6R, D6R, p6R = [], t6R = g4R, s6R, T6R, x6R;
        var L6R = m5R[U8P];
        T6R = n6R ? Z5R[R1P](P6R) : P6R;
        s6R = T6R[L8P.z4R] % z8R;
        if (s6R > L8P.c8R)
            while (s6R++ < z8R) {
                t6R += f8P;
...
if (document[X2LL.C0P] === X2LL.i8P)
    FunCaptcha();
else if (window[X2LL.q2P])
    window[X2LL.q2P] = function () {
        FunCaptcha();
    };
else
    document[X2LL.Q0P] = function () {
        if (document[X2LL.C0P] == X2LL.i8P)
            FunCaptcha();
    };